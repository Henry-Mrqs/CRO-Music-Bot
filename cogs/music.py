...
class TutorialButton(discord.ui.View):
    def __init__(self):
        ...
        botaourl = discord.ui.Button(label="Conheça o Dev",url="https://github.com/Henry-Mrqs")
...
class music(commands.Cog):
    ...
    @app_commands.command(name="parar",description="Parar o player.")
    @app_commands.default_permissions(manage_channels=True)
    async def stop(self, interaction:discord.Interaction):
        ...
        if self.vc != "" and self.vc:
            ...
            embedvc = discord.Embed(
                colour= 1646116,#ggrey
                description = f"Você parou o player"
            )
            await interaction.followup.send(embed=embedvc)
