...
class SubButton(discord.ui.View):
    def __init__(self):
        ...
        botaourl = discord.ui.Button(label="LinkedIn",url="https://www.linkedin.com/in/henry-marques-211047170/")
...
async def sync(ctx,guild=None):
    ...
    await ctx.send("**Sincronizado!** Espero que aproveite!",view=SubButton())
